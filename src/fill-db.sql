...
INSERT INTO COMMENTS (ARTICLEID,

														USERID,
														CREATEDDATE, TEXT)
VALUES (4, 3, '2021-11-07 10:35:40.954', 'Мне не нравится ваш стиль. Ощущение, что вы меня поучаете. Хочу такую же футболку :-) Планируете записать видосик на эту тему Мне кажется или я уже читал это где-то? Согласен с автором! Совсем немного... Это где ж такие красоты?'),
							(4, 4, '2021-10-19 10:35:40.954', 'Планируете записать видосик на эту тему Мне кажется или я уже читал это где-то? Это где ж такие красоты?'),
							(5, 1, '2021-11-21 10:35:40.954', 'Мне кажется или я уже читал это где-то?'),
							(5, 5, '2021-10-18 10:35:40.954', 'Плюсую, но слишком много буквы! Мне кажется или я уже читал это где-то? Совсем немного...'),
							(5, 2, '2021-11-07 10:35:40.954', 'Согласен с автором!'),
							(6, 3, '2021-11-07 10:35:40.954', 'Ощущение, что вы меня поучаете.'),
							(6, 6, '2021-11-21 10:35:40.954', 'Давно не пользуюсь стационарными компьютерами. Ноутбуки победили.')
